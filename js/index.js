...
document.getElementById("box").onchange=function(){
  ...
  document.getElementById("closeF").checked = !this.checked
};
...
function directory(x){
  ...
  if(printingItem===true){
    ...
    if(saveAll===true){
  var numIns = Number(numDurk)+Number(openAll);
  }else{
  ...
  if(saveAll===true){
    var numIns = Number(numDurk)+Number(openAll);
  }else{var numIns = Number(numDurk)+1};

  document.getElementById("inWycena").innerHTML=numIns;
  
}
var closeFile = document.getElementById("closeF").checked?true:false;
var sender = ('var fabric={fabric:"'+fabric+'",printingItem:"'+printingItem+'",reDpi:"'+IDpi+'",closeF:"'+closeFile+'",newName:"'+newName+'",newPath:"'+newPath+'",saveAll:"'+saveAll+'"};');
  //alert(sender)
...
function inner(){
  csInterface.evalScript('getDocData()', function(res){
    ...
    infoArr[3]!=="U.S. Web Coated (SWOP) v2"? document.getElementById('colorType').style="color: #DC143C;": document.getElementById('colorType').style.color="#ECECEC";
    document.getElementById('profil').innerHTML=infoArr[4];
    infoArr[4]!=="DocumentMode.CMYK"? document.getElementById('profil').style="color: #DC143C;": document.getElementById('profil').style.color="#ECECEC";
